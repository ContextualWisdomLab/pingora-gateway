use cwl_pingora_gateway::runtime_policy::{
    build_server_conf, V1_DEFAULT_SERVICE_THREADS, V1_GRACEFUL_SHUTDOWN_TIMEOUT_SECONDS,
    V1_GRACE_PERIOD_SECONDS, V1_MAX_UPSTREAM_ATTEMPTS,
};
...
fn version_one_overrides_pingora_retry_capacity_and_shutdown_defaults() {
    ...
    assert_eq!(conf.threads, V1_DEFAULT_SERVICE_THREADS);
