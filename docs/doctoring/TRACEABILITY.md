...
Cloudflare. (n.d.). *Pingora upstream peer options* [Source code, tag 0.3.0]. GitHub. https://github.com/cloudflare/pingora/blob/0.3.0/pingora-core/src/upstreams/peer.rs

Cloudflare. (n.d.). *Pingora upstream peer options* [Source code, tag 0.1.1]. GitHub. https://github.com/cloudflare/pingora/blob/0.1.1/pingora-core/src/upstreams/peer.rs

Cloudflare. (n.d.). *Pingora upstream peer options* [Source code, tag 0.1.0]. GitHub. https://github.com/cloudflare/pingora/blob/0.1.0/pingora-core/src/upstreams/peer.rs
