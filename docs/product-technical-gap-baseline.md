...
Minimal causal repair `8027ebfbd4c9f020783e1bb5d4af5c4d0f6b4ca5` applies only that formatter-required layout. Current exact Actions are CI `34013844984` and Supply Chain `34013844913`; `oci-runtime 101434140937`, `load-contract 101434140984`, `test 101434141021`, and `candidate-evidence 101434140612` remain fresh-head queued before checkout after two reads. Terminal exact-head execution and current-head review are required before GREEN. The prior `6f6b6fea...` review marker is not transferred across the formatting commit.
