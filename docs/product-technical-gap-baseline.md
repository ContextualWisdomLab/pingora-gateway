...
Current Draft #12 is exact `f10ddaede49df1bdca65a82478eabc80e591282f`, exact base repaired #11 `e33ae30c981dff0907fe42e21b2d3184f7ccc066`, mergeable, with 17 effective files. Exact CI `34080901878` and Supply Chain `34080901932` are queued on this current head. The predecessor `774d62f...` runs are no longer current-head evidence; predecessor execution and review do not transfer. Fresh exact-head technical review must bind to `e33ae30c...f10ddae`. Until this exact head proves formatting, compile/test, strict Clippy, rustdoc, complete owned coverage, resolved lock, load/OCI and supply-chain evidence, the pg-erd repair remains candidate work rather than GREEN succession.
