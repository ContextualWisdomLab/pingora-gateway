...
A further dependency-root inspection found a platform-dependent socket-authority gap on exact `7aae2384215fb3918195a8a003ecb9c37f202eab`: same-port `[::]` plus an IPv4 listener/metrics address was still admitted even though the IPv6 wildcard may consume IPv4 authority when `IPV6_V6ONLY` is disabled. The live #12 branch now carries explicit TDD repair:

- RED `d1c67d4562f6979489ab85e096690b6fb376711f` adds symmetric `[::]`/IPv4 collision expectations while preserving distinct concrete IPv4/IPv6 acceptance;
- GREEN `7a1f2703e42d1a597955ebc03f35009bda363f8d` minimally extends the migration-local overlap predicate to reject only the cross-family IPv6-wildcard case, matching the already-demonstrated descendant conservative socket-authority semantics without absorbing that descendant's broader generic/upstream authority work;
- docs `d3c3dc6184651e31f829f97e9b6ddf8f246c1476` makes the Admin Config contract explicit about equal, same-family wildcard/concrete, and platform-dependent IPv6-wildcard/IPv4 overlap rejection.

Current Draft #12 is exact `d3c3dc6184651e31f829f97e9b6ddf8f246c1476`, exact base repaired #11 `e33ae30c981dff0907fe42e21b2d3184f7ccc066`, mergeable, with 17 effective files. Exact CI `34079484920` and Supply Chain `34079484924` are queued on that head; predecessor execution and review do not transfer. A fresh exact-head CodeRabbit review has been explicitly requested against `e33ae30c...d3c3dc6`. Until this exact head proves formatting, compile/test, strict Clippy, rustdoc, complete owned coverage, resolved lock, load/OCI and supply-chain evidence, the pg-erd repair remains candidate work rather than GREEN succession.
