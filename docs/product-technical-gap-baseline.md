...
Fresh protected owner state is `.github/main@dd0b96feded94f66ecf59b25a5a9b58cfc8b4f69`, integrating #1960's Strix sandbox-vs-provider review-finding attribution repair. That change does not satisfy #1952's Nginx/Pingora responsibility-classification finding.

Owner handoff `.github#1952` remains open. Overlapping #1946 remains open at exact `790ef33ea60ada7d21503ca57ccf955a1a36d44b` and changes the same four central policy files required by #1952 for a distinct oversized-Contents/Git-Blobs repair. Exact comparison against protected `main@dd0b96fe...` is diverged at ahead 3 / behind 4 with merge base `43024633eba9d96b0456970391360da5a171fbda`. The owner-safe sequence remains ordinary non-force reconciliation/integration of #1946, followed by #1952's static-only-vs-edge-runtime responsibility-profile RED→GREEN. The Pingora lane updated the existing coordination comment in place and did not modify `.github` source/ref/PR state.
