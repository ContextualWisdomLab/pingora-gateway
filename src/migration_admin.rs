...
/// addresses are compared as their mapped IPv4 authority so wildcard and concrete aliases cannot
/// bypass validation. Distinct concrete non-aliased addresses remain independent.
